...
var _weatherCodesJs = require("./weather-codes.js");
var _weatherCodesJsDefault = parcelHelpers.interopDefault(_weatherCodesJs);
...
now.innerText = `${new Date().getDate()}.${new Date().getMonth() + 1}.${new Date().getFullYear()}`;
...
async function getGeolocation(city = "Bern") {
    const dt = await fetchData(`https://geocoding-api.open-meteo.com/v1/search?name=${city}&count=1&language=en&format=json`);
    const locations = {
...
function getAllData(city) {
    ...
    locations.then((data)=>{
        ...
        weatherAPIData.then((data)=>{
            ...
            const weatherCodes = (0, _weatherCodesJsDefault.default);
            let desc = (0, _weatherCodesJsDefault.default)[weather_code].day.description;
            let img = (0, _weatherCodesJsDefault.default)[weather_code].day.image;
            display.innerHTML = `${temperature} \xbaC`;
            ...
            switch(desc){
                ...
                case "Sunny":
                    ...
                    document.body.style.backgroundImage = "url('https://www.bpmcdn.com/f/files/similkameen/import/2019-04/16560263_web1_180604_KCN_weather-update.jpg;w=900')";
                    break;
                case "Partly Sunny":
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT","./weather-codes.js":"beLDA"}],"jnFvT":[function(require,module,exports,__globalThis) {
...
},{}],"beLDA":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["n0fw4","kTBnD"], "kTBnD", "parcelRequirebbde", {})

//# sourceMappingURL=weather-app.3c14d121.js.map
